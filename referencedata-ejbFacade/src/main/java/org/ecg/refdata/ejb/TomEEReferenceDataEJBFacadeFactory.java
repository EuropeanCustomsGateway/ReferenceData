 ...
 *
 */
public class TomEEReferenceDataEJBFacadeFactory extends
        AbstractReferenceDataFactory {

    private static final Log log = LogFactory.getLog(TomEEReferenceDataEJBFacadeFactory.class);
...
//            http://127.0.0.1:8080/tomee/ejb
            properties.put("java.naming.provider.url", "http://" + hostAndIp + "/tomee/ejb");
